...
const createNumber = (html : HTMLDivElement, end: boolean = false, create: boolean = false) => {
...
const finishLoad = (firstHTML : HTMLElement, secondHTML : HTMLElement, tercerHTML : HTMLElement) => {
